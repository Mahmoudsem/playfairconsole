       ...
       public static int Mod(int a, int b)
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Console.WriteLine("  Press 1 To Encrypt :: 2 To Decrypt ");
                ...
                {
                    enCipher = Decipher(plainText, "cipher");
                    Console.WriteLine("Dcryptet Text Is " + enCipher);
                }
                Console.WriteLine("Press Y To Countine N To Exit ");
